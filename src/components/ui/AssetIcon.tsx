...
export const ICONS = {
  ...
  cherry: "/assets/icons/apps/cherry-network.png",
  ...
  folder: "/assets/icons/places/folder-explorer.svg",
  ...
  trash: "/assets/icons/places/recycle-bin.svg",
  trashFull: "/assets/icons/places/recycle-bin.svg",
